...
public class MainActivity extends AppCompatActivity {
    ...
    private void observerListadoProductos(List<ProductoBO> productos) {
        if(productos == null || productos.size() == 0) { //Si no hay productos en la BBDD
            ...
            listaProductos.add(new ProductoBO("Yogurt natural Danone",1.19,2.48,"Yogures",R.drawable.producto_yogurt_danone));
            listaProductos.add(new ProductoBO("Manzanas",0.99,1.69,"Frutas",R.drawable.producto_manzanas));
            listaProductos.add(new ProductoBO("Plátanos de Canarias",3.09,3.09,"Frutas",R.drawable.producto_platano));
            listaProductos.add(new ProductoBO("Aceite de oliva virgen extra 1L",4.15,4.15,"Alimentacion",R.drawable.producto_aceite_virgen_extra));
            listaProductos.add(new ProductoBO("Ron barcelo",14.35,20.43,"Bebidas",R.drawable.producto_ron_barcelo));
            listaProductos.add(new ProductoBO("Cacahuetes con miel",0.99,7.92,"Aperitivos",R.drawable.producto_cacahute_con_miel));
            ...
            listaProductos.add(new ProductoBO("Frutos secos",2.79,5.58,"Aperitivos",R.drawable.producto_frutos_secos));
            listaProductos.add(new ProductoBO("Pasta de dientes Colgate",3.09,20.6,"Higiene",R.drawable.producto_pasta_dientes));
            listaProductos.add(new ProductoBO("Natillas Danone Vainilla",2.09,4.35,"Yogures",R.drawable.producto_natillas_vainilla));
            listaProductos.add(new ProductoBO("Macarrones 1kg",1.12,1.12,"Alimentacion",R.drawable.producto_macarrones));
            listaProductos.add(new ProductoBO("Huevos L 12ud",1.65,1.65,"Huevos",R.drawable.producto_huevos));
            listaProductos.add(new ProductoBO("Nuggets 350g",4.15,11.86,"Precocinados",R.drawable.producto_nuggets));
            listaProductos.add(new ProductoBO("Chocolate relleno oreo Milka",2.63,2.63,"Aperitivos",R.drawable.producto_chocolate_milka));
